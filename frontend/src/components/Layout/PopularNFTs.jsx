    ...
    <section className="relative w-full min-h-screen py-20 flex flex-col items-center justify-center overflow-hidden">
      <div className="w-full max-w-[1400px] mx-auto px-4">
        ...
        >
          <Text 
            as="h2"
            className="font-zen !text-white !text-4xl md:!text-5xl lg:!text-6xl !mb-8 text-center max-w-4xl"
          >
            Popular NFTs generated by Artists
          </Text>
          <Text 
            className="!text-white/80 !max-w-3xl !text-base md:!text-lg text-center"
            weight="light"
          >
        ...
        >
          ...
          {/* Third Row */}
          <motion.div variants={fadeInUp} className="col-start-2">
            <img 
